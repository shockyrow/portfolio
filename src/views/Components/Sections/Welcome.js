                ...
                <div className="d-flex flex-column justify-content-center align-items-center text-center vh-100">
                    ...
                    <div className="my-5 py-5 px-2">
                        ...
                        <div className="text-center d-flex justify-content-center">
                            <a href={CV} className="btn btn-lg btn-outline-primary col-10 col-md-6 shadow mt-5 d-flex justify-content-center align-items-center" download="IbrokhimShokirovCV">
                                <span className="px-1"><i className="fa fa-2x fa-download"/></span>
                                <h2 className="px-1">Resume</h2>
                            </a>
                        </div>
                    </div>
                </div>
